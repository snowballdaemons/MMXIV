...
**
** Created: Thu Dec 11 07:55:41 2014
...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_MMXIV_copyright = new QLabel(AboutDialog);
        label_MMXIV_copyright->setObjectName(QString::fromUtf8("label_MMXIV_copyright"));
        label_MMXIV_copyright->setWordWrap(true);
        label_MMXIV_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_MMXIV_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MMXIV", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>MMXIV</b> version", 0, QApplication::UnicodeUTF8));
        label_MMXIV_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 MMXIV Developers", 0, QApplication::UnicodeUTF8));
